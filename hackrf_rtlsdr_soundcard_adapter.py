...
# Title: Top Block
# Generated: Thu Nov  5 12:49:38 2015
##################################################
...
class top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_1 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, audio_rate, dstar_bandwidth, 200, firdes.WIN_HAMMING, 6.76))
        ...
        self.baz_non_blocker_0 = baz.non_blocker(8, False)
        ...
        self.analog_fm_demod_cf_0 = analog.fm_demod_cf(
        	...
        	audio_stop=dstar_bandwidth*2+1e3,
        	gain=1,
        	tau=0,
        )
        ...
        self.connect((self.baz_non_blocker_0, 0), (self.analog_fm_demod_cf_0, 0))    
        ...
        self.connect((self.low_pass_filter_1, 0), (self.baz_non_blocker_0, 0))    
    ...
    def set_dstar_bandwidth(self, dstar_bandwidth):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.audio_rate, self.dstar_bandwidth, 200, firdes.WIN_HAMMING, 6.76))
